  ...
  return profileData && (
    <div>
      <div className='flex flex-col gap-4 m-5'>
        <div>
          <img className='bg-primary/80 w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="doc_img" />
        </div>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex items-center gap-2 mt-1 text-gray-600'>
            ...
            <button className='py-0.5 px-2 border border-[#DADADA] text-xs rounded-full'>{profileData.experience}</button>
          </div>
          ...
          <div className='flex gap-1 pt-2'>
            <input checked={profileData.available} type="checkbox" className='accent-blue-600' onChange={() => isEdit && setProfileData(prev => ({ ...prev, available: !prev.available }))} />
