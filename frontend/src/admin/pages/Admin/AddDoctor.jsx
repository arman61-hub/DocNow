      ...
      <div className='bg-white px-8 py-8 border border-[#DADADA] rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Speciality</p>
              <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border border-[#DADADA] rounded px-3 py-2' >
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Eductaion</p>
              <input onChange={(e) => setDegree(e.target.value)} value={degree} className='border border-[#DADADA] rounded px-3 py-2' type="text" placeholder='Eductaion' required />
            </div>
